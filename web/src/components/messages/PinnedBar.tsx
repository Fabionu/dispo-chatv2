          ...
          <div className="flex items-start gap-3 py-2">
              ...
              {visible.map((m) => (
                <div key={m.id} className="group/pin flex items-center gap-1">
                  ...
                  <button
                    ...
                    title="Unpin"
                    className="h-6 w-6 inline-flex items-center justify-center text-faint hover:text-text hover:bg-white/6 transition-colors shrink-0 opacity-0 group-hover/pin:opacity-100 focus:opacity-100"
                  >
            ...
            {multiple && (
              <button
                ...
                className="h-7 w-7 inline-flex items-center justify-center text-muted hover:text-text hover:bg-white/6 transition-colors shrink-0"
              >
                <ChevronDown
                  size="0.9375rem"
                  strokeWidth={1.8}
