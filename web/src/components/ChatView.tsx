          ...
          <div className="flex-1 flex flex-col relative min-h-0">
            ...
            {showScrollDown && (
              <button
                ...
                className="absolute left-1/2 -translate-x-1/2 z-10 h-9 w-9 rounded-tile bg-surface border border-line text-text hover:bg-surface-2 hover:border-line-2 flex items-center justify-center transition-colors shadow-raised"
              >
