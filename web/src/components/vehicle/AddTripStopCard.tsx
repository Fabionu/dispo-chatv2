...
export default function AddTripStopCard({
  ...
  return (
    <div className="flex items-center gap-2 rounded-card bg-white/4 px-2.5 py-2">
      <span className="text-sm font-medium shrink-0">{labelOf(STOP_TYPES, stop.type)}</span>
      ...
      <button
        ...
        title="Remove stop"
        className="rounded-btn h-6 w-6 shrink-0 flex items-center justify-center text-faint hover:text-alert hover:bg-white/4 transition-colors"
      >
